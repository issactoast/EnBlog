...
## Replacing $x$ by $Y_{\lfloor n\alpha\rfloor}$ is a <span style="color:red">Red-Herring</span> ![alt text](https://static.tvtropes.org/pmwiki/pub/images/red_herring1.png =50x50).
